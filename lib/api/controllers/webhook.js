...
function post(req, res) {
    ...
    // If we don't send OK response, Telegram will stop hitting
    // this webhook.
    res.status(200);
...
function postLogic(req, res) {
    ...
    try {
        if (body.message.chat.type == "private") {
            ...
            isDirect = true;
            tgName = `${body.message.chat.first_name} ${body.message.chat.last_name}`;
        }
    } catch {}
